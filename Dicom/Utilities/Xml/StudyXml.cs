...
namespace Macro.Dicom.Utilities.Xml
{
    /// <summary>
    ...
    public class StudyXml : IEnumerable<SeriesXml>
    {
        ...
        public XmlDocument GetMemento(StudyXmlOutputSettings settings)
        {
            ...
            XmlElement Macro = _doc.CreateElement("MacroStudyXml");
            ...
            Macro.AppendChild(study);
            _doc.AppendChild(Macro);
        ...
        public void SetMemento(XmlDocument theDocument)
        {
            ...
            while (rootNode != null && !rootNode.Name.Equals("MacroStudyXml"))
