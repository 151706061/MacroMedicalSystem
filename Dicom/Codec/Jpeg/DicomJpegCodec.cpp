...
namespace Jpeg {
	...
	Macro::Dicom::TransferSyntax^ DicomJpegCodec::CodecTransferSyntax::get()
	{ 
		return nullptr;
	}
	
	Macro::Dicom::TransferSyntax^ DicomJpegProcess1Codec::CodecTransferSyntax::get()  {
		return Macro::Dicom::TransferSyntax::JpegBaselineProcess1;
	}
	String^ DicomJpegProcess1Codec::Name::get()  {
		return Macro::Dicom::TransferSyntax::JpegBaselineProcess1->Name;	
	}
	...
	String^ DicomJpegProcess24Codec::Name::get()  {
		return Macro::Dicom::TransferSyntax::JpegExtendedProcess24->Name;	
	}
	...
	String^ DicomJpegLossless14Codec::Name::get()  {
		return Macro::Dicom::TransferSyntax::JpegLosslessNonHierarchicalProcess14->Name;	
	}

    Macro::Dicom::TransferSyntax^ DicomJpegLossless14SV1Codec::CodecTransferSyntax::get()  {
		return Macro::Dicom::TransferSyntax::JpegLosslessNonHierarchicalFirstOrderPredictionProcess14SelectionValue1;
	}
	String^ DicomJpegLossless14SV1Codec::Name::get()  {
		return Macro::Dicom::TransferSyntax::JpegLosslessNonHierarchicalFirstOrderPredictionProcess14SelectionValue1->Name;	
	}
