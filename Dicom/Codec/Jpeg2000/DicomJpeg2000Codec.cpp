...
OPJ_COLOR_SPACE getOpenJpegColorSpace(String^ photometricInterpretation) {
	...
	Macro::Dicom::TransferSyntax^ DicomJpeg2000Codec::CodecTransferSyntax::get()
	{ 
		return nullptr;
	}
	
	Macro::Dicom::TransferSyntax^ DicomJpeg2000LossyCodec::CodecTransferSyntax::get()  {
	...
	Macro::Dicom::TransferSyntax^ DicomJpeg2000LosslessCodec::CodecTransferSyntax::get()  {
...
void DicomJpeg2000Codec::Encode(DicomUncompressedPixelData^ oldPixelData, DicomCompressedPixelData^ newPixelData, DicomCodecParameters^ parameters) {
	...
	for (int frame = 0; frame < oldPixelData->NumberOfFrames; frame++) {
		...
		// Comment
		eparams.cp_comment = "Macro DICOM OpenJPEG";
