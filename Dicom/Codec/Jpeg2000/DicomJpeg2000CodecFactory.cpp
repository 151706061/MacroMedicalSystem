...
namespace Jpeg2000 {
	...
	Macro::Dicom::TransferSyntax^ DicomJpeg2000LosslessCodecFactory::CodecTransferSyntax::get()  {
		return Macro::Dicom::TransferSyntax::Jpeg2000ImageCompressionLosslessOnly;
	}
	String^ DicomJpeg2000LosslessCodecFactory::Name::get()  {
		return Macro::Dicom::TransferSyntax::Jpeg2000ImageCompressionLosslessOnly->Name;	
	}
	...
	String^ DicomJpeg2000LossyCodecFactory::Name::get()  {
		return Macro::Dicom::TransferSyntax::Jpeg2000ImageCompression->Name;	
	}
