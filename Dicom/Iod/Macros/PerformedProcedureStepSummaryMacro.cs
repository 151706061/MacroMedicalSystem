...
using Macro.Dicom.Iod.Macros.PerformedProcedureStepSummary;
using Macro.Dicom.Iod.Macros.PerformedProcedureStepSummary.PerformedProtocolCodeSequence;
using Macro.Dicom.Utilities;

namespace Macro.Dicom.Iod.Macros
{
	/// <summary>
	...
	internal class PerformedProcedureStepSummaryMacro : IodBase, IPerformedProcedureStepSummaryMacro
	{
		...
		/// <summary>
		/// Gets an enumeration of <see cref="Macro.Dicom.DicomTag"/>s used by this macro.
		/// </summary>
