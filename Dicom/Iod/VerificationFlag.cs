...
namespace Macro.Dicom.Iod
{
	/// <summary>
	/// Enumerated values for the <see cref="Macro.Dicom.DicomTags.VerificationFlag"/> attribute indicating whether the Encapsulated Document is verified.
	/// </summary>
	/// <remarks>
