...
namespace Macro.Dicom.Iod.Sequences
{
	...
	/// <summary>
	/// Enumerated values for the <see cref="Macro.Dicom.DicomTags.MaskSelectionMode"/> attribute specifying the method of selection of the mask operations of this item.
	/// </summary>
