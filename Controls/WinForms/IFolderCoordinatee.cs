...
namespace Macro.Controls.WinForms
{
	...
	{
		/// <summary>
		/// Gets the <see cref="Macro.Controls.WinForms.Pidl"/> to which the coordinatee is synchronized.
		/// </summary>
		/// <remarks>
		/// Implementations should <b>NOT</b> return a new instance of a <see cref="Macro.Controls.WinForms.Pidl"/>,
		...
		/// <summary>
		/// Synchronizes the coordinatee to the specified <see cref="Macro.Controls.WinForms.Pidl"/>.
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		/// <param name="pidl">The <see cref="Macro.Controls.WinForms.Pidl"/> to which the coordinatee should be synchronized.</param>
