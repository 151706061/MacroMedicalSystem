...
using Macro.ImageServer.Core.Diagnostics;
...
using SaveDicomFileCommand = Macro.ImageServer.Core.Command.SaveDicomFileCommand;
using Settings=Macro.ImageServer.Core.Diagnostics.Settings;
