...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneralWorkQueueDetailsView.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.GeneralWorkQueueDetailsView" %>
