...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TierMigrationWorkQueueDetailsView.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.TierMigrationWorkQueueDetailsView" %>
