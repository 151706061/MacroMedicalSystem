...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebMoveStudyWorkQueueDetailsView.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.WebMoveStudyWorkQueueDetailsView" %>
