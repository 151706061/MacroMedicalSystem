...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcessDuplicateWorkQueueDetailsView.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.ProcessDuplicateWorkQueueDetailsView" %>
