...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserPanel.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Admin.UserManagement.Users.UserPanel" %>
