...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AlertHoverPopupDetails.ascx.cs" Inherits="Macro.ImageServer.Web.Application.Pages.Admin.Dashboard.AlertHoverPopupDetails" %>
