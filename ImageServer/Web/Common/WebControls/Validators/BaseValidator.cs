...
namespace Macro.ImageServer.Web.Common.WebControls.Validators
{
    ...
    public abstract class BaseValidator : System.Web.UI.WebControls.BaseValidator
    {
        ...
        {
            var template =
                new ScriptTemplate(this, "Macro.ImageServer.Web.Common.WebControls.Validators.BaseValidator.js");
            ...
            template =
                new ScriptTemplate(this,
                                   "Macro.ImageServer.Web.Common.WebControls.Validators.BaseValidator_OnClientValidation.js");
