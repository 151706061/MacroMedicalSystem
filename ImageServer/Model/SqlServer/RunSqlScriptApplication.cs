...
using Macro.ImageServer.Enterprise.SqlServer;

namespace Macro.ImageServer.Model.SqlServer
{
        ...
        public void RunApplication(string[] args)
        {
            ...
            try
            {
                ...
                if (cmdLine.Switches.ContainsKey("storedprocedures") && cmdLine.Switches["storedprocedures"])
                {
                    ...
                    if (!RunEmbeddedScript("Macro.ImageServer.Model.SqlServer.Scripts.ImageServerStoredProcedures.sql"))
                ...
                {
                    Console.WriteLine("Upgrading the stored procedures.");
                    if (!RunEmbeddedScript("Macro.ImageServer.Model.SqlServer.Scripts.ImageServerDefaultData.sql"))
                        Environment.ExitCode = -1;
                    else
                        Environment.ExitCode = 0;
                }
