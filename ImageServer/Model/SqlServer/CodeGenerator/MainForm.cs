...
namespace Macro.ImageServer.Model.SqlServer.CodeGenerator
{
    public partial class MainForm : Form
    {
        ...
        private void comboBoxDatabase_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                textBoxModelNamespace.Text = "Macro.ImageServer.Model";
                textBoxEntityInterfaceNamespace.Text = "Macro.ImageServer.Model.EntityBrokers";
                textBoxEntityImplementationNamespace.Text = "Macro.ImageServer.Model.SqlServer.EntityBrokers";
                textBoxModelFolder.Text = "d:\\Projects\\Macro\\ImageServer\\Model";
                textBoxEntityInterfaceFolder.Text = "d:\\Projects\\Macro\\ImageServer\\Model\\EntityBrokers";
                textBoxEntityImplementationFolder.Text = "d:\\Projects\\Macro\\ImageServer\\Model\\SqlServer\\EntityBrokers";
            }
            if (comboBoxDatabase.SelectedItem.Equals("MigrationTool"))
            {
                textBoxModelNamespace.Text = "Macro.Migration.Dicom.Model";
                textBoxEntityInterfaceNamespace.Text = "Macro.Migration.Dicom.Model.EntityBrokers";
                textBoxEntityImplementationNamespace.Text = "Macro.Migration.Dicom.Model.SqlServer.EntityBrokers";
            ...
            {
                textBoxModelNamespace.Text = "Macro.UsageTracking.Model";
                textBoxEntityInterfaceNamespace.Text = "Macro.UsageTracking.Model.EntityBrokers";
                textBoxEntityImplementationNamespace.Text = "Macro.UsageTracking.Model.SqlServer.EntityBrokers";
