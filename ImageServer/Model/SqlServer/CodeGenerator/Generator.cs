    ...
    public class Generator
    {
        ...
        private void WriterHeader(TextWriter writer, string nameSpace)
        {
            ...
            if (Proprietary)
            {
                ...
                writer.WriteLine("// contact Macro, Inc. at info@Macro.ca");
            }
            else
            {
            ...
            writer.WriteLine("");
            writer.WriteLine("// This file is auto-generated by the Macro.Model.SqlServer.CodeGenerator project.");
            writer.WriteLine("");
        ...
        private void WriteEnumBrokerInterfaceFile(Table table)
        {
            ...
            writer.WriteLine("    using Macro.ImageServer.Enterprise;");
            writer.WriteLine("");
        ...
        private void WriteEnumBrokerImplementationFile(Table table)
        {
            ...
            writer.WriteLine("    using Macro.Common;");
            writer.WriteLine("    using {0};", EntityInterfaceNamespace);
            writer.WriteLine("    using Macro.ImageServer.Enterprise.SqlServer;");
            writer.WriteLine("");
        ...
        private void WriteModelFile(Table table)
        {
            ...
            if (bDicomReference)
                writer.WriteLine("    using Macro.Dicom;");
            writer.WriteLine("    using Macro.Enterprise.Core;");
            writer.WriteLine("    using Macro.ImageServer.Enterprise;");
            writer.WriteLine("    using {0};", EntityInterfaceNamespace);
            writer.WriteLine("");
