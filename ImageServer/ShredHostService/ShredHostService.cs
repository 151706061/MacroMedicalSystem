...
namespace Macro.ImageServer.ShredHostService
{
    public partial class ShredHostService : ServiceBase
    {
        ...
        internal static void InternalStart()
        {
            ...
            // Macro.Server.ShredHost.dll would also need to be Strong Name signed
            _assembly = Assembly.Load("Macro.Server.ShredHost");
            _shredHostType = _assembly.GetType("Macro.Server.ShredHost.ShredHost");
