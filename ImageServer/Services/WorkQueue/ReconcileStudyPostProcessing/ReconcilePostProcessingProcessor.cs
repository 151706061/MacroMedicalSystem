...
using Macro.ImageServer.Services.WorkQueue.StudyProcess;
...
namespace Macro.ImageServer.Services.WorkQueue.ReconcileStudyPostProcessing
{
    ...
    class ReconcilePostProcessingProcessor : StudyProcessItemProcessor
	{
		...
		protected override void ProcessFile(Model.WorkQueueUid queueUid, DicomFile file, Macro.Dicom.Utilities.Xml.StudyXml stream, bool compare)
		{
