...
using Macro.ImageServer.Services.WorkQueue.DeleteStudy;
using DeleteDirectoryCommand = Macro.ImageServer.Core.Command.DeleteDirectoryCommand;

namespace Macro.ImageServer.Services.WorkQueue.WebDeleteStudy
{
