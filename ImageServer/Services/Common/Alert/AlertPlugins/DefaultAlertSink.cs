...
namespace Macro.ImageServer.Services.Common.Alert.AlertPlugins
{
   
    /// <summary>
    /// Represents an alert service extension that stores <see cref="Macro.ImageServer.Common.Alert"/> in the database or log file, whichever available.
    /// </summary>
