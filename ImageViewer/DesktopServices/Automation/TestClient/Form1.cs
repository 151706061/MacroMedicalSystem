...
#if USE_ASP
using Macro.ImageViewer.DesktopServices.Automation.TestClient.ViewerAutomationAsp;
using Macro.ImageViewer.DesktopServices.Automation.TestClient.StudyLocatorAsp;
using Macro.ImageViewer.DesktopServices.Automation.TestClient.DicomExplorerAutomationAsp;
using DicomExplorerAutomationClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.DicomExplorerAutomationAsp.DicomExplorerAutomation;
using AutomationClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.ViewerAutomationAsp.ViewerAutomation;
using QueryClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.StudyLocatorAsp.StudyLocator;
#else
using Macro.ImageViewer.DesktopServices.Automation.TestClient.ViewerAutomation;
using Macro.ImageViewer.DesktopServices.Automation.TestClient.DicomExplorerAutomation;
using DicomExplorerAutomationClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.DicomExplorerAutomation.DicomExplorerAutomationClient;
using AutomationClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.ViewerAutomation.ViewerAutomationClient;
using QueryClient = Macro.ImageViewer.DesktopServices.Automation.TestClient.StudyLocator.StudyRootQueryClient;
using StudyRootStudyIdentifier = Macro.ImageViewer.DesktopServices.Automation.TestClient.StudyLocator.StudyRootStudyIdentifier;
