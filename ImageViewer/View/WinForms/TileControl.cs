...
using DrawMode=Macro.ImageViewer.Rendering.DrawMode;
using MessageBox=Macro.Desktop.View.WinForms.MessageBox;
	    ...
	    private void OnContextMenuStripOpening(object sender, CancelEventArgs e)
		{
			...
			if (_tileController.ContextMenuEnabled)
			{
				...
				if (menuModel != null && menuModel.ChildNodes.Count > 0)
				{
					...
					// (Macro Ticket #4775, Microsoft Connect Issue #136061)
