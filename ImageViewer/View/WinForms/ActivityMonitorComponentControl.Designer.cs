...
namespace Macro.ImageViewer.View.WinForms
{
	partial class ActivityMonitorComponentControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._workItemsTableView = new Macro.Desktop.View.WinForms.TableView();
			...
			this._diskSpaceMeter = new Macro.Desktop.View.WinForms.Meter();
			...
			this._statusLight = new Macro.Desktop.View.WinForms.IndicatorLight();
		...
		private Macro.Desktop.View.WinForms.TableView _workItemsTableView;
