...
{
	/// <summary>
	/// An <see cref="AnnotationBox"/> is rendered to the screen by an <see cref="Macro.ImageViewer.Rendering.IRenderer"/>.
	/// </summary>
	...
	public sealed class AnnotationBox
	{
		...
		/// <summary>
		/// Defines the normalized rectangle in which the <see cref="Macro.ImageViewer.Rendering.IRenderer"/> should render the text.
		/// </summary>
