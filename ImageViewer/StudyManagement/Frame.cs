...
namespace Macro.ImageViewer.StudyManagement
{
	...
	public partial class Frame : IDisposable
	{
		...
		/// </summary>
		/// <remarks>
		/// If no value exists in the image header, or the value is invalid, a <see cref="Macro.Dicom.Iod.PixelAspectRatio"/>
		/// is returned whose <see cref="Macro.Dicom.Iod.PixelAspectRatio.IsNull"/> property evaluates to true.
		/// </remarks>
