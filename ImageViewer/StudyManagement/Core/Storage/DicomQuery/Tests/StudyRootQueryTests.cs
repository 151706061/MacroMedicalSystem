...
using Macro.ImageViewer.Common.Configuration.Tests;
using Macro.ImageViewer.Common.DicomServer.Tests;
using Macro.ImageViewer.StudyManagement.Core.ServiceProviders;
using NUnit.Framework;

namespace Macro.ImageViewer.StudyManagement.Core.Storage.DicomQuery.Tests
{
    //TODO (CR Marmot): case insensitivity.

    [TestFixture]
    public class StudyRootQueryTests : Macro.Dicom.Tests.AbstractTest
    {
