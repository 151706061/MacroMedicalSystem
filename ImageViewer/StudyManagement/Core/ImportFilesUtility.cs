...
using Macro.ImageViewer.StudyManagement.Core.Command;
using Macro.ImageViewer.StudyManagement.Core.Storage;
using Macro.ImageViewer.StudyManagement.Core.WorkItemProcessor;
using AuditedInstances = Macro.Dicom.Audit.AuditedInstances;
using EventResult = Macro.Dicom.Audit.EventResult;
using EventSource = Macro.Dicom.Audit.EventSource;
