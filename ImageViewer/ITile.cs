...
namespace Macro.ImageViewer
{
	...
	public interface ITile : IDrawable, IDisposable
	{
		...
		/// <summary>
		/// Gets or sets this <see cref="ITile"/>'s <see cref="Macro.ImageViewer.InformationBox">InformationBox</see>.
		/// </summary>
		InformationBox InformationBox { get; set; }

		/// <summary>
		/// Gets or sets this <see cref="ITile"/>'s <see cref="Macro.ImageViewer.EditBox">EditBox</see>.
		/// </summary>
