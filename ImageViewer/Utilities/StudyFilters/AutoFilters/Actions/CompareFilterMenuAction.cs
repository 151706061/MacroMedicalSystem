...
using Macro.ImageViewer.Utilities.StudyFilters.Utilities;
using Action=Macro.Desktop.Actions.Action;

namespace Macro.ImageViewer.Utilities.StudyFilters.AutoFilters.Actions
{
	[ExtensionPoint]
