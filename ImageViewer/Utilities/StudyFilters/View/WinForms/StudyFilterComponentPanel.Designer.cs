namespace Macro.ImageViewer.Utilities.StudyFilters.View.WinForms
{
	partial class StudyFilterComponentPanel {
		...
		private void InitializeComponent() {
			...
			this._tableView = new Macro.ImageViewer.Utilities.StudyFilters.View.WinForms.StudyFilterTableView();
		...
		private Macro.ImageViewer.Utilities.StudyFilters.View.WinForms.StudyFilterTableView _tableView;
