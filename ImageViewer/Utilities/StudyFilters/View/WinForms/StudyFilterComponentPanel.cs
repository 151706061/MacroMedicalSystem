...
namespace Macro.ImageViewer.Utilities.StudyFilters.View.WinForms
{
	public partial class StudyFilterComponentPanel : UserControl
	{
		...
		public StudyFilterComponentPanel(StudyFilterComponent component) : this()
		{
			...
			ActionModelRoot toolbarActions = ActionModelRoot.CreateModel("Macro.ImageViewer.Utilities.StudyFilters.View.WinForms", StudyFilterTool.DefaultToolbarActionSite, _component.ExportedActions);
