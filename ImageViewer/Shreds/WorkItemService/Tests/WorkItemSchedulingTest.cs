...
using Macro.Common;
using Macro.Common.Caching;
using Macro.Common.Utilities;
using Macro.Dicom;
using Macro.Dicom.Tests;
using Macro.ImageViewer.Common.StudyManagement.Tests;
using Macro.ImageViewer.Common.WorkItem;
using Macro.ImageViewer.Shreds.WorkItemService.DeleteStudy;
using Macro.ImageViewer.Shreds.WorkItemService.DicomRetrieve;
using Macro.ImageViewer.Shreds.WorkItemService.DicomSend;
using Macro.ImageViewer.Shreds.WorkItemService.Import;
using Macro.ImageViewer.Shreds.WorkItemService.ProcessStudy;
using Macro.ImageViewer.Shreds.WorkItemService.ReapplyRules;
using Macro.ImageViewer.Shreds.WorkItemService.Reindex;
using Macro.ImageViewer.StudyManagement.Core.Storage;
using Macro.ImageViewer.StudyManagement.Core.WorkItemProcessor;
using NUnit.Framework;

namespace Macro.ImageViewer.Shreds.WorkItemService.Tests
{
