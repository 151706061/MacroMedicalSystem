...
namespace Macro.ImageViewer.Comparers
{
	/// <summary>
	...
	public abstract class DicomSeriesComparer : DisplaySetComparer, IComparer<Series>, IComparer<Sop>
	{
		...
		/// </summary>
		/// <remarks>Simply calls <see cref="Compare(Macro.ImageViewer.StudyManagement.Sop,Macro.ImageViewer.StudyManagement.Sop)"/>,
