...
namespace Macro.ImageViewer.BaseTools
{
	...
	/// default <see cref="Macro.ImageViewer.InputManagement.MouseButtonShortcut"/>.
	/// </summary>
	/// <seealso cref="MouseImageViewerTool"/>
	/// <seealso cref="Macro.ImageViewer.InputManagement.MouseButtonShortcut"/>
	/// <seealso cref="Macro.ImageViewer.InputManagement.IViewerShortcutManager"/>
