...
using GraphicObject = Macro.Dicom.Iod.Sequences.GraphicAnnotationSequenceItem.GraphicObjectSequenceItem;
using TextObject = Macro.Dicom.Iod.Sequences.GraphicAnnotationSequenceItem.TextObjectSequenceItem;
