namespace Macro.ImageViewer.TestTools.Rendering.TestApp
{
	partial class RenderingSurfaceContainer
	{
		...
		private void InitializeComponent()
		{
			...
			this._renderingSurface = new Macro.ImageViewer.TestTools.Rendering.TestApp.RenderingSurface();
			...
			this._renderingSurface.Source = Macro.ImageViewer.TestTools.Rendering.TestApp.GraphicsSource.Default;
