	...
	public class ChangeTransferSyntaxTool : StudyBrowserTool
	{
		...
		public override IActionSet Actions
		{
			get
			{
				...
				foreach (IDicomCodecFactory factory in Macro.Dicom.Codec.DicomCodecRegistry.GetCodecFactories())
				{
		...
		private void ChangeToSyntax(IBackgroundTaskContext context)
		{
			...
			try
			{
				_tempPath = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "Macro");
