...
namespace Macro.ImageViewer.InputManagement
{
	...
	/// <remarks>
	/// <para>
	/// The framework will look for this interface first on graphic objects (<see cref="Macro.ImageViewer.Graphics.IGraphic"/>) 
	/// in the current <see cref="IPresentationImage"/>'s SceneGraph (see <see cref="PresentationImage.SceneGraph"/>), then on 
	/// <see cref="Macro.Desktop.Tools.ITool"/>s belonging to the current <see cref="IImageViewer"/> 
	...
	/// <seealso cref="Macro.ImageViewer.Graphics.IGraphic"/>
	/// <seealso cref="Macro.ImageViewer.Graphics.Graphic"/>
