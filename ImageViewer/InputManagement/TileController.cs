...
{
	/// <summary>
	/// This class controls the behaviour of objects in the <see cref="ITile"/>, namely the <see cref="Macro.ImageViewer.Graphics.IGraphic"/>s 
	/// in the current <see cref="IPresentationImage"/>'s SceneGraph (<see cref="PresentationImage.SceneGraph"/>) and <see cref="Macro.Desktop.Tools.ITool"/>s 
	...
	/// <item>
	/// <description>
	/// - When the mouse moves without any buttons down, all <see cref="Macro.ImageViewer.Graphics.IGraphic"/>s 
	/// that implement <see cref="IMouseButtonHandler"/> have their <see cref="IMouseButtonHandler.Track"/> method called.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// - When a mouse button is clicked, an <see cref="Macro.ImageViewer.Graphics.IGraphic"/> is searched for at the current mouse position
	...
	/// If no <see cref="Macro.ImageViewer.Graphics.IGraphic"/> is found, then all of the current <see cref="IPresentationImage"/>'s 
	/// <see cref="Macro.Desktop.Tools.ITool"/>s are searched for an <see cref="IMouseButtonHandler"/> and the same rules are applied.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	...
	/// However, only <see cref="Macro.Desktop.Tools.ITool"/>s are given the opportunity to handle the mouse wheel, not <see cref="Macro.ImageViewer.Graphics.IGraphic"/>s.
	/// </description>
	/// </item>
	/// </list>
	/// </para>
	...
	/// <seealso cref="Macro.Desktop.Tools.ITool"/>
	/// <seealso cref="Macro.ImageViewer.BaseTools.ImageViewerTool"/>
	/// <seealso cref="Macro.ImageViewer.BaseTools.MouseImageViewerTool"/>
