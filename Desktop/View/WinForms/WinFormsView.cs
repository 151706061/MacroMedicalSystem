...
namespace Macro.Desktop.View.WinForms
{
    ...
    /// </summary>
    [GuiToolkit(Macro.Common.GuiToolkitID.WinForms)]
    public abstract class WinFormsView
    {
        ...
        /// <summary>
        /// Gets the toolkit ID, which is always <see cref="Macro.Common.GuiToolkitID.WinForms"/>.
        /// </summary>
        public string GuiToolkitID
        {
            get { return Macro.Common.GuiToolkitID.WinForms; }
        }
