namespace Macro.Desktop.View.WinForms.Configuration {
	partial class ActionModelConfigurationComponentControl {
		...
		private void InitializeComponent() {
			...
			this._actionModelTree = new Macro.Desktop.View.WinForms.BindingTreeView();
			...
			this._actionModelTree.IconResourceSize = Macro.Desktop.IconSize.Small;
		...
		private Macro.Desktop.View.WinForms.BindingTreeView _actionModelTree;
