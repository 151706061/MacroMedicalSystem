...
namespace Macro.Desktop
{
    ...
    [MenuAction("launch", "global-menus/MenuTools/MenuUtilities/×ÀÃæ¼àÊÓÆ÷", "Launch")]
    ...
    public class DesktopMonitorComponent : ApplicationComponent
    {
        ...
        public override void Start()
        {
            ...
            Application.DesktopWindows.ItemOpened += new EventHandler<Macro.Common.Utilities.ItemEventArgs<DesktopWindow>>(Windows_ItemOpened);
            Application.DesktopWindows.ItemOpening += new EventHandler<Macro.Common.Utilities.ItemEventArgs<DesktopWindow>>(Windows_ItemOpening);
            ...
            Application.DesktopWindows.ItemActivationChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<DesktopWindow>>(Windows_ItemActivationChanged);
            Application.DesktopWindows.ItemVisibilityChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<DesktopWindow>>(Windows_ItemVisibilityChanged);
        ...
        {
            window.Workspaces.ItemOpening += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Workspace>>(Workspaces_ItemOpening);
            window.Workspaces.ItemOpened += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Workspace>>(Workspaces_ItemOpened);
            ...
            window.Workspaces.ItemActivationChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Workspace>>(Workspaces_ItemActivationChanged);
            window.Workspaces.ItemVisibilityChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Workspace>>(Workspaces_ItemVisibilityChanged);
            window.Shelves.ItemOpening += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Shelf>>(Shelves_ItemOpening);
            window.Shelves.ItemOpened += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Shelf>>(Shelves_ItemOpened);
            ...
            window.Shelves.ItemActivationChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Shelf>>(Shelves_ItemActivationChanged);
            window.Shelves.ItemVisibilityChanged += new EventHandler<Macro.Common.Utilities.ItemEventArgs<Shelf>>(Shelves_ItemVisibilityChanged);
        }
