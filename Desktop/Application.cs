...
namespace Macro.Desktop
{
    ...
    public class Application : IApplicationRoot
    {
        ...
        /// <seealso cref="Macro.Desktop.DesktopWindow.ShowMessageBox(string, MessageBoxActions)"/>
		/// <seealso cref="Macro.Desktop.DesktopWindow.ShowMessageBox(string, string, MessageBoxActions)"/>
