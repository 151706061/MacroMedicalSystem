    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			else if (!String.IsNullOrEmpty(commandLine.PreviousExeConfigurationFilename))
			{
				...
				groups.Add(new SettingsGroupDescriptor(typeof (ShredSettingsMigrator).Assembly.GetType("Macro.Server.ShredHost.ShredHostServiceSettings")));
