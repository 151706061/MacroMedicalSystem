...
namespace Macro.Server.ShredHost
{
    public static class ShredHost
    {
        ...
        public static bool Start()
        {
            ...
            ExtensionScanner scanner = (ExtensionScanner)AppDomain.CurrentDomain.CreateInstanceFromAndUnwrap(Assembly.GetExecutingAssembly().Location, "Macro.Server.ShredHost.ExtensionScanner");
