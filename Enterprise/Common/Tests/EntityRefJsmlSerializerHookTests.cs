...
namespace Macro.Enterprise.Common.Tests
{
	[TestFixture]
	public class EntityRefJsmlSerializerHookTests
	{
		...
		{
			var guidEntityRef = new EntityRef("Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:G:0fa8fdae-4678-40d7-bc54-9ca700e646d9:0");
			SerializeHelper(guidEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:G:0fa8fdae-4678-40d7-bc54-9ca700e646d9:0</Tag>");
			DeserializeHelper(guidEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:G:0fa8fdae-4678-40d7-bc54-9ca700e646d9:0</Tag>");

			var stringEntityRef = new EntityRef("Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:S:0fa8fdae-4678-40d7-bc54-9ca700e646d9:1");
			SerializeHelper(stringEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:S:0fa8fdae-4678-40d7-bc54-9ca700e646d9:1</Tag>");
			DeserializeHelper(stringEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:S:0fa8fdae-4678-40d7-bc54-9ca700e646d9:1</Tag>");

			var intEntityRef = new EntityRef("Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:I:123456:2");
			SerializeHelper(intEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:I:123456:2</Tag>");
			DeserializeHelper(intEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:I:123456:2</Tag>");

			var longEntityRef = new EntityRef("Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:L:12345678901234567:3");
			SerializeHelper(longEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:L:12345678901234567:3</Tag>");
			DeserializeHelper(longEntityRef, "<Tag>Macro.Healthcare.ExternalPractitioner, Macro.Healthcare:L:12345678901234567:3</Tag>");
